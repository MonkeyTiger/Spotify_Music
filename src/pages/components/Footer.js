...
class Footer extends Component {
  ...
  _handleClick(text) {
    ReactGA.ga('send', 'event', 'button', 'footer', text);
  }
  ...
  render() {
    ...
    return <div className={style}>
      <div className='copy'>
        ...
        <a href='https://dribbble.com/curva'
          target='_blank'
          rel="noopener noreferrer"
          onClick={this._handleClick.bind(this, '@aschelstraete')}>
          @aschelstraete
        </a> /
        <a href='https://github.com/loverajoel/magicplaylist'
          onClick={this._handleClick.bind(this, 'github')}
          target='_blank'
          rel="noopener noreferrer">
          Source Code
        </a> /
        <a href='https://twitter.com/magicplaylistco'
